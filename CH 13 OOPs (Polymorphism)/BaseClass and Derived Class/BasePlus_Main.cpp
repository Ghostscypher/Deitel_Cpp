...
int main()
{
	...
	cout << "\n\nCalling print with base-class pointer to"
	"\nDerived-class object invokes base class print function:\n";
	cEmployeePtr->print(); // Invokes base-class class print
	
	// This will cause an error
	// Aim derived-class pointer to base-class object
	cout << "Aiming derived class pointer to base class object, causes an error\n";
	bpEmployeePtr = &cEmployee;
} // End main